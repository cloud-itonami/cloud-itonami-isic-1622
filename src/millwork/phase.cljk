(ns millwork.phase
  "Phase 0->3 staged rollout for the millwork-shop plant-operations
  coordination actor.
  ...
  consequence (a cutting/joinery/finishing-line maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `millwork.governor`'s `cutting-line-finalize-blocked-violations`
...
(defn verdict->disposition
  "Map a Millwork Shop Plant Operations Governor verdict to a base
