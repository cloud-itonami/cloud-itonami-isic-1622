# Business Model: Manufacture of builders' carpentry and joinery
...
## Classification
- Repository: `cloud-itonami-isic-1622` ([github.com/cloud-itonami/cloud-itonami-isic-1622](https://github.com/cloud-itonami/cloud-itonami-isic-1622))
- ISIC Rev.5: `1622` — Manufacture of builders' carpentry and joinery
- Domain: `:wood-products/builders-carpentry-joinery`
- Social impact: :worker-safety :local-economy :resource-efficiency
- Actor: `:millwork-shop-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :wood-products/builders-carpentry-joinery — who wants
...
One managed tenant (:wood-products/builders-carpentry-joinery):
...
- Do not bypass the `:millwork-shop-plant-operations-governor` for production decisions.
