# Operator Quickstart — Manufacture of builders' carpentry and joinery

Shortest path from clone to a verified local dry-run for **ISIC 1622** (`cloud-itonami-isic-1622`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1622.git
cd cloud-itonami-isic-1622
```
...
- Blueprint governor key: `millwork-shop-plant-operations-governor`
- Likely source path: `millwork.governor.cljc`
